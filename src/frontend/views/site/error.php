...
<div class="el-container">
    <div class="error">
        ...
        <svg class="error__ico" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
        ...
        <div class="error__links">
            <a href = "javascript:void(0);" onclick="history.back();"><?=Yii::t("app/error", "back") ?></a>
            <a href = "<?=Url::to(['/site/index'])?>"><?=Yii::t("app/error", "main") ?></a>
        </div>
