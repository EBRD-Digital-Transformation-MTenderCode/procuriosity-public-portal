    ...
    <div class="header-second">
        <section class="el-container is-vertical">
            ...
            <nav class="header-entity-nav">
                <div
                    <?= (Yii::$app->request->get('type') == 'plans' || Yii::$app->request->get('type') == 'budgets') ? 'class="header-entity-nav_tab-WP is-active"' : 'class=header-entity-nav_tab-WP' ?>>
                    <div> <?= Yii::t("app/header", "nav-plan") ?></div>
